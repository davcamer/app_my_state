...
def readData():
  ...
  for row in reader:
    ...
    data.append({CATEGORY: row[CATEGORY_COLUMN], DESCRIPTION: row[DESCRIPTION_COLUMN], LATITUDE: lat, LONGITUDE: lon})
...
def writeJavaScriptOutput(data):
  ...
  lineTemplate = string.Template("  {category: '$category', description: '$description', latitude: '$latitude', longitude: '$longitude'},\n")
  groupEnd = "];\n"
